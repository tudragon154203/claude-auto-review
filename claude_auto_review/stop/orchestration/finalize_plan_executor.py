...
def _apply_finalize_plan_result(
    ctx: RuntimeContext, plan: Any, review_id: str, review_path: Path, covered_entries: list[Any], unreviewed: list[Any], *, emitter=None
    ...
    if plan.effect == FinalizeEffect.RECORD_FINDINGS_BLOCK:
        ...
        StateEventWriter(ctx.project_root, ctx.client_id).append(findings_result.state_record)
