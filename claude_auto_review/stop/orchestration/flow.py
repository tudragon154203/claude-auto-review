...
from claude_auto_review.settings import get_setting_float, get_setting_int, load_settings
...
def run_stop_flow(project_root, payload):
    ...
    timeout_hours = get_setting_float(settings, "pendingReviewTimeoutHours", 1)
    ...
    max_passes = get_setting_int(settings, "maxStopPasses", 3)
