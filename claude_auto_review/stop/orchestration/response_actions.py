...
def complete_clean_review(project_root, client_id, review_id, covered_entries, apply_completed_review):
...
def block_pending_review(project_root, client_id, review_id, review_path, unreviewed):
