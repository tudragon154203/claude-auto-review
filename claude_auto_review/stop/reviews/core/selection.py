from claude_auto_review.state.core.models import EditRecord, ReviewMetadata, StateEvent
...
def get_entries_covered_by_review(review_entry: ReviewMetadata, state_entries):
