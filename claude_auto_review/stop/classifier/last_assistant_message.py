...
from claude_auto_review.settings import get_setting_float
...
def classify_last_assistant_message(project_root, client_id, payload, settings, env=None, urlopen=None):
    ...
    timeout_seconds = get_setting_float(settings, "lastAssistantMessageClassifierTimeoutSeconds", DEFAULT_TIMEOUT_SECONDS)
