...
class TestStateStore(StateTestCase, unittest.TestCase):
    def test_loads_latest_unreviewed_file_entries(self):
        ...
        append_state_event(
            EditRecord(timestamp="2026-05-05T08:00:00+07:00", file="a.ts", hash="11111111"), project_root
        )
        append_state_event(
            EditRecord(
                timestamp="2026-05-05T09:00:00+07:00", file="a.ts", hash="22222222", reviewed=True, reviewId="rev-1"
            ),
            project_root,
        )
        append_state_event(
            EditRecord(timestamp="2026-05-05T10:00:00+07:00", file="b.ts", hash="33333333"), project_root
        )
