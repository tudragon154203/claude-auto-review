...
class TestFinalizeReviewStop(unittest.TestCase):
    ...
    @patch("claude_auto_review.stop.finalize_review_stop.classify_last_assistant_message")
    @patch("claude_auto_review.stop.finalize_review_stop.get_entries_covered_by_review", return_value=[])
    @patch("claude_auto_review.stop.finalize_review_stop.is_review_clean", return_value=True)
    @patch("claude_auto_review.stop.finalize_review_stop.is_review_complete", return_value=True)
    @patch("claude_auto_review.stop.finalize_review_stop.apply_completed_review", return_value=[])
    ...
    @patch("claude_auto_review.stop.finalize_review_stop.is_review_clean", return_value=True)
    @patch("claude_auto_review.stop.finalize_review_stop.is_review_complete", return_value=True)
    @patch("claude_auto_review.stop.finalize_review_stop.apply_completed_review", return_value=[{"file": "still.ts"}])
    ...
    @patch("claude_auto_review.stop.finalize_review_stop.classify_last_assistant_message")
    @patch("claude_auto_review.stop.finalize_review_stop.get_entries_covered_by_review", return_value=[])
    @patch("claude_auto_review.stop.finalize_review_stop.attempt_stop_autocomplete", return_value=True)
    @patch("claude_auto_review.stop.finalize_review_stop.is_review_complete", return_value=False)
    ...
    @patch("claude_auto_review.stop.finalize_review_stop.classify_last_assistant_message")
    @patch("claude_auto_review.stop.finalize_review_stop.append_state")
    @patch("claude_auto_review.stop.finalize_review_stop.get_entries_covered_by_review", return_value=[])
    @patch("claude_auto_review.stop.finalize_review_stop.attempt_stop_autocomplete", return_value=False)
    @patch("claude_auto_review.stop.finalize_review_stop.is_review_complete", return_value=False)
    ...
    @patch("claude_auto_review.stop.finalize_review_stop.get_entries_covered_by_review", return_value=[])
    @patch("claude_auto_review.stop.finalize_review_stop.is_review_clean", return_value=False)
    @patch("claude_auto_review.stop.finalize_review_stop.is_review_complete", return_value=True)
    ...
    @patch("claude_auto_review.stop.finalize_review_stop.get_entries_covered_by_review", return_value=[])
    @patch("claude_auto_review.stop.finalize_review_stop.attempt_stop_autocomplete", return_value=False)
    @patch("claude_auto_review.stop.finalize_review_stop.is_review_clean", side_effect=[False])
    @patch("claude_auto_review.stop.finalize_review_stop.is_review_complete", side_effect=[False, True])
