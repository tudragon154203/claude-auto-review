...
class TestResolvePendingReview(unittest.TestCase):
    ...
    @patch("claude_auto_review.stop.orchestration.core.pending.find_pending_review_for_files")
    @patch("claude_auto_review.stop.orchestration.core.pending.run_review_prompt", side_effect=subprocess.TimeoutExpired(cmd="x", timeout=60))
    ...
    @patch("claude_auto_review.stop.orchestration.core.pending.find_pending_review_for_files")
    @patch("claude_auto_review.stop.orchestration.core.pending.run_review_prompt", side_effect=OSError("boom"))
