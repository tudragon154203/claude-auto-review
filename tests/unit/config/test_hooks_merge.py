...
class TestMergeUniqueHookList(unittest.TestCase):
    @patch("claude_auto_review.config.io.hooks.is_plugin_hook", return_value=False)
    @patch("claude_auto_review.config.io.hooks.plugin_script_name_from_hook", return_value="")
    ...
    @patch("claude_auto_review.config.io.hooks.is_plugin_hook", side_effect=[True, True])
    @patch("claude_auto_review.config.io.hooks.plugin_script_name_from_hook", return_value="script.sh")
    ...
    @patch("claude_auto_review.config.io.hooks.is_plugin_hook", side_effect=[True, False])
    @patch("claude_auto_review.config.io.hooks.plugin_script_name_from_hook", return_value="script.sh")
