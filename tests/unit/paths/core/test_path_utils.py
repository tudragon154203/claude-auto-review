...
from claude_auto_review.runtime.core.client_dirs import (
...
class TestPathUtils(StateTestCase, unittest.TestCase):
    ...
    def test_get_client_runtime_dir_refreshes_deleted_cached_path(self):
        ...
        with patch("claude_auto_review.runtime.core.client_dirs._timestamped_client_runtime_dir", return_value=expected):
