...
from claude_auto_review.paths.core.path_utils import get_project_root, local_now_iso
...
class TestClientId(StateTestCase, unittest.TestCase):
    ...
    def test_get_client_id_uses_unknown_when_hostname_lookup_fails(self):
        with mock.patch.dict(os.environ, {}, clear=True):
            with mock.patch("claude_auto_review.runtime.core.client_dirs.socket.gethostname", side_effect=OSError("boom")):
                result = get_client_id()
