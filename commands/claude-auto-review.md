...
That wrapper calls `claude_auto_review/review/prompt.py`, which uses `claude_auto_review/review/prompting/flow.py` to build the prompt and initialize the review file.
